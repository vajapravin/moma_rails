...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { artist_id: @painting.artist_id, image_url: @painting.image_url, title: @painting.title, year: @painting.year }
    end
  ...
  test "should update painting" do
    patch :update, id: @painting, painting: { artist_id: @painting.artist_id, image_url: @painting.image_url, title: @painting.title, year: @painting.year }
    assert_redirected_to painting_path(assigns(:painting))
  end
